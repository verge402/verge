    ...
    <main className="bg-paper">
      ...
      <article className="max-w-[760px] mx-auto px-6 py-20">
        ...
        <p className="ink-mid text-[17px] leading-[1.55] mb-12">
          Monetize any HTTP endpoint with USDC on Base. No accounts, no API keys.
        </p>
...
{ "ok": true, "message": "unlocked" }`}</pre>
        ...
        <p className="ink-mid mb-4 leading-[1.55]">
          Provide your own Base RPC and verify locally:
        </p>
  ...
  rpcUrl: "https://base-mainnet.g.alchemy.com/v2/YOUR_KEY",
        ...
        <ul className="space-y-2 ink-mid">
          <li>
            <a
              ...
              rel="noopener"
            >
              github.com/vergesnowyx402/verge
            </a>{" "}
            — SDK source
          </li>
          <li>
        ...
        <div className="mt-16 p-6 rounded-[14px] border border-line bg-soft">
          ...
          <p className="ink leading-[1.55] mb-4">
            We're onboarding 100 endpoints before mainnet launch — 0% fees on your first 1M
            requests.
          </p>
          <a href="/#waitlist" className="btn btn-primary !text-[13px]">
            Get on the list →
          </a>
        </div>
      </article>
