...
const networks = [
  { name: "Circle", logo: "/logos/circle.svg", href: "https://circle.com" },
  { name: "Uniswap", logo: "/logos/uniswap.png", href: "https://uniswap.org" },
  { name: "Aerodrome", logo: "/logos/aerodrome.jpg", href: "https://aerodrome.finance" },
    ...
    >
      <div className={`${animClass} gap-8 md:gap-14`} style={{ ["--ticker-speed" as string]: speed }}>
        {[...items, ...items].map((_, i) => (
          ...
          >
            <span className="text-white/[0.3]">Base </span>
