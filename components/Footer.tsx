        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          ...
          <div>
            ...
            <p className="text-[13px] text-gray-500 leading-relaxed max-w-[420px]">
              Base-native HTTP 402 payment rails for AI agents.
          ...
          <div className="flex flex-wrap gap-x-10 gap-y-6 text-[13px]">
            ...
            <FooterCol
              ...
              links={[
                ...
                { href: "https://www.clanker.world/clanker/0xc5F069Bf8b8eCc19f0fB70Eb6884781B0132AB07", label: "$VERGE on Clanker" },
