...
const facts = [
  { num: "400ms",   label: "Base block time",   body: "Fast enough that a 402 → pay → retry round-trip feels synchronous." },
  { num: "$0.0001", label: "Average tx fee",      body: "Stripe's network fee on a $0.001 call would be infinite. Base's is zero." },
  { num: "65k TPS", label: "Network capacity",    body: "Spawn 10,000 agent micropayments per second without queueing." },
  { num: "1 RPC",   label: "BYO infrastructure",  body: "Plug in Helius, Triton, or run your own validator. No Verge lock-in." },
];
        ...
        <Reveal>
          <div className="max-w-[680px] mb-12 md:mb-14">
            ...
            <p className="text-gray-400 text-sm md:text-base">
              ...
              <em className="text-emerald-400 not-italic font-medium">useful</em> on Base.
            </p>
          </div>
        </Reveal>
