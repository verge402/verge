...
const rows: Array<{
  ...
  { label: "Currency",        verge: "USDC, ETH",stripe: "USD/EUR/…",   selfhost: "USDC, ETH" },
            ...
            <div className="relative">
              ...
              <div className="bg-[#1B1B1C] rounded-[20px] p-7 border border-emerald-500/30 shadow-[0_0_40px_-12px_rgba(52,211,153,0.2)]">
                ...
                <ul className="space-y-2 text-[14px] text-gray-400 leading-[1.55]">
                  <li className="flex gap-2"><span className="text-emerald-400 shrink-0">&#x2713;</span><span>400ms USDC settlement on Base</span></li>
                  ...
                  <li className="flex gap-2"><span className="text-emerald-400 shrink-0">&#x2713;</span><span>Self-host with BYO Base RPC</span></li>
                </ul>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal delay={300}>
            <div className="bg-[#1B1B1C] rounded-[20px] p-7 border border-[#2a2a2e] opacity-75">
              ...
              <ul className="space-y-2 text-[14px] text-gray-500 leading-[1.55]">
                ...
                <li className="flex gap-2"><span className="shrink-0">&mdash;</span><span>BYO Base RPC (Alchemy / QuickNode)</span></li>
