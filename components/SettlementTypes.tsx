        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <Reveal delay={200}>
            <div className="bg-[#1B1B1C] rounded-[20px] md:rounded-[24px] p-6 md:p-8 border border-[#2a2a2e]">
              ...
              <ul className="space-y-3 text-[14px] text-gray-400 leading-[1.5]">
                <li className="flex gap-2"><span className="text-emerald-400 shrink-0">&#x2713;</span>USDC + ETH supported</li>
          ...
          <Reveal delay={300}>
            <div className="bg-[#1B1B1C] rounded-[20px] md:rounded-[24px] p-6 md:p-8 border border-[#2a2a2e]">
              ...
              <ul className="space-y-3 text-[14px] text-gray-400 leading-[1.5]">
                <li className="flex gap-2"><span className="text-emerald-400 shrink-0">&#x2713;</span>USDC only</li>
